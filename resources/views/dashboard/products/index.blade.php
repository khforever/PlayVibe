                                        ...
                                        @foreach ($products as $product)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="{{ route('comments.index', $product->id) }} "
                                                    ...
                                                    <a href="{{ route('products.edit', $product->id) }}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="40"
                                                            ...
                                                            <g fill="none">
                                                                ...
                                                                <defs>
                                                                    <linearGradient id="SVGU1eE1b5T" x1="20.694"
                                                                        x2="13.492" y1="31.456" y2="9.925"
                                                                        gradientUnits="userSpaceOnUse">
                                                                        <stop stop-color="#b3e0ff" />
                                                                        <stop offset="1" stop-color="#b3e0ff" />
                                                                    </linearGradient>
                                                                    <linearGradient id="SVGkFtYpesI" x1="18.786"
                                                                        x2="22.353" y1="17.182" y2="33.578"
                                                                        gradientUnits="userSpaceOnUse">
                                                                        <stop stop-color="#dcf8ff" stop-opacity="0" />
                                                                        <stop offset="1" stop-color="#ff6ce8"
                                                                            stop-opacity="0.7" />
                                                                    </linearGradient>
                                                                    <linearGradient id="SVGkHpQsC8g" x1="14.727"
                                                                        x2="17.137" y1="14.077" y2="30.097"
                                                                        gradientUnits="userSpaceOnUse">
                                                                        <stop stop-color="#0078d4" />
                                                                        <stop offset="1" stop-color="#0067bf" />
                                                                    </linearGradient>
                                                                    <linearGradient id="SVGR8qwqQEB" x1="3"
                                                                        x2="25.069" y1="3" y2="-4.352"
                                                                        gradientUnits="userSpaceOnUse">
                                                                        <stop stop-color="#0094f0" />
                                                                        <stop offset="1" stop-color="#2764e7" />
                                                                    </linearGradient>
                                                                    <linearGradient id="SVGuLUjtdLw" x1="19.861"
                                                                        x2="26.044" y1="19.948" y2="26.149"
                                                                        gradientUnits="userSpaceOnUse">
                                                                        <stop stop-color="#ffa43d" />
                                                                        <stop offset="1" stop-color="#fb5937" />
                                                                    </linearGradient>
                                                                    <linearGradient id="SVGLFchkdje" x1="14.174"
                                                                        x2="18.325" y1="26.847" y2="30.975"
                                                                        gradientUnits="userSpaceOnUse">
                                                                        <stop offset=".255" stop-color="#ffd394" />
                                                                        <stop offset="1" stop-color="#ff921f" />
                                                                    </linearGradient>
                                                                    <linearGradient id="SVGbvsSaeki" x1="28.502"
                                                                        x2="25.869" y1="17.485" y2="19.968"
                                                                        gradientUnits="userSpaceOnUse">
                                                                        <stop stop-color="#f97dbd" />
                                                                        <stop offset="1" stop-color="#dd3ce2" />
                                                                    </linearGradient>
                                                                    <linearGradient id="SVGPCCetcDD" x1="25.469"
                                                                        x2="21.489" y1="21.663" y2="19.902"
                                                                        gradientUnits="userSpaceOnUse">
                                                                        <stop stop-color="#ff921f" />
                                                                        <stop offset="1" stop-color="#ffe994" />
                                                                    </linearGradient>
                                                                    <radialGradient id="SVGJ3aOCI1z" cx="0"
                                                                        cy="0" r="1"
                                                                    ...
                                                                    <filter id="SVGzEwpPcLX" width="16.667"
                                                                        height="10.667" x="7.667" y="14.333"
